...
const loadCustomer = async()=>{
 ...
 const res = await axios.get(
  `https://khatabook-mern-app-azew.onrender.com/api/customers/${id}?userId=${userId}`)
...
const loadTransactions = async()=>{
 ...
 const res = await axios.get(
 `https://khatabook-mern-app-azew.onrender.com/api/transactions/${id}/${userId}?page=${page}&limit=10`
)
 ...
 try{
  ...
  if(editingId){
   ...
   const res = await axios.put(
    `https://khatabook-mern-app-azew.onrender.com/api/transactions/${editingId}`,
    {
   ...
   const res = await axios.post(
    "https://khatabook-mern-app-azew.onrender.com/api/transactions",
    {
     customerId:id,
     amount:Number(amount),
     type,
...
const deleteTransaction = async(tid)=>{
 ...
 try{
  ...
  await axios.delete(
   `https://khatabook-mern-app-azew.onrender.com/api/transactions/${tid}`,
   { data:{ userId } }
  )
